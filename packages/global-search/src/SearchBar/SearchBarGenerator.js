      ...
      return (
        <div className={classes.searchContainer}>
          <Autocomplete
            ...
            onChange={(event, val) => onChange(val, searchRoute, event)}
            ...
            renderInput={(params) => (
              <CustomTextField
                ...
                onClick={(val) => onChange(val, searchRoute)}
                onEnter={(val) => onChange(val, searchRoute)}
              />
            )}
          />
          {showSearchButton && (
            <div
              ...
              tabIndex={0}
              onClick={() => onChange(inputValue, searchRoute)}
            >
