    ...
    <>
      ...
      {Math.ceil(count / pageSize) > 1 && (
        <div className={classes.paginationContainer}>
          <Button id="global_search_paginate_prev" onClick={onPrevious} className={classes.prevButton} aria-label="Go to previous page">
            <span>
              <img
          ...
          />
          <Button id="global_search_paginate_next" onClick={onNext} className={classes.nextButton} aria-label="Go to next page">
            next
            <span>
              <img
