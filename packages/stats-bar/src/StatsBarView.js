...
const styles = () => ({
  ...
  statsGroup: (props) => ((props.styles.global && props.styles.global.horizontalStyle) ? {
    ...
    minWidth: props.styles.statsGroup ? props.styles.statsGroup.minWidth ? props.styles.statsGroup.minWidth : '180px' : '180px',
    maxWidth: props.styles.statsGroup ? props.styles.statsGroup.maxWidth ? props.styles.statsGroup.maxWidth : '185px' : '185px',
    '&:first-child': {
      minWidth: props.styles.statsGroup ? props.styles.statsGroup.minWidthFirst ? props.styles.statsGroup.minWidthFirst : '190px' : '190px',
      maxWidth: props.styles.statsGroup ? props.styles.statsGroup.maxWidthFirst ? props.styles.statsGroup.maxWidthFirst : '225px' : '225px',
      padding: '6px 20px 10px 90px',
    },
    '&:last-child': {
      borderRight: 'none',
      minWidth: props.styles.statsGroup ? props.styles.statsGroup.minWidthLast ? props.styles.statsGroup.minWidthLast : '205px' : '190px',
      maxWidth: props.styles.statsGroup ? props.styles.statsGroup.maxWidthLast ? props.styles.statsGroup.maxWidthLast : '225px' : '225px',
